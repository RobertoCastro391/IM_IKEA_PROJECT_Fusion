...
public enum Speech implements IModality {
	...
	SELECT_PRODUCT_BY_POSITION_1("[SPEECH][SELECT_PRODUCT_BY_POSITION][1]", 5000),
	SELECT_PRODUCT_BY_POSITION_2("[SPEECH][SELECT_PRODUCT_BY_POSITION][2]", 5000),
	SELECT_PRODUCT_BY_POSITION_3("[SPEECH][SELECT_PRODUCT_BY_POSITION][3]", 5000),
	SELECT_PRODUCT_BY_POSITION_4("[SPEECH][SELECT_PRODUCT_BY_POSITION][4]", 5000),
	SELECT_PRODUCT_BY_POSITION_5("[SPEECH][SELECT_PRODUCT_BY_POSITION][5]", 5000),
	SELECT_PRODUCT_BY_POSITION_6("[SPEECH][SELECT_PRODUCT_BY_POSITION][6]", 5000),
	SELECT_PRODUCT_BY_POSITION_7("[SPEECH][SELECT_PRODUCT_BY_POSITION][7]", 5000),
	SELECT_PRODUCT_BY_POSITION_8("[SPEECH][SELECT_PRODUCT_BY_POSITION][8]", 5000),
	SELECT_PRODUCT_BY_POSITION_9("[SPEECH][SELECT_PRODUCT_BY_POSITION][9]", 5000),
	SELECT_PRODUCT_BY_POSITION_10("[SPEECH][SELECT_PRODUCT_BY_POSITION][10]", 5000),
