 ...
 */   
 ...
 public enum Speech implements IModality{  
	 ...
	 SEARCH_PRODUCT_CAMAS("[SPEECH][SHOW_PRODUCTS][CAMAS]",1500),
	 SEARCH_PRODUCT_CADEIRAS("[SPEECH][SHOW_PRODUCTS][CADEIRAS]",1500),
	 SEARCH_PRODUCT_ARMARIOS("[SPEECH][SHOW_PRODUCTS][ARMARIOS]",1500),
	 SEARCH_PRODUCT_ESTANTES("[SPEECH][SHOW_PRODUCTS][ESTANTES]",1500),
	 SEARCH_PRODUCT_SOFAS("[SPEECH][SHOW_PRODUCTS][SOFAS]",1500),
