 ...
 */   
 ...
 public enum Speech implements IModality{  
	 ...
	 ADD_PRODUCT_CART("[SPEECH][ADD_PRODUCT_CART]",5000),
	 ADD_PRODUCT_FAVORITES("[SPEECH][ADD_PRODUCT_FAVORITES]",5000),
	 REMOVE_PRODUCT_CART("[SPEECH][REMOVE_PRODUCT_CART]",5000),
	 REMOVE_PRODUCT_FAVORITES("[SPEECH][REMOVE_PRODUCT_FAVORITES]",5000),
